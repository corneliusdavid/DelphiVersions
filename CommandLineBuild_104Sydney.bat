...
REM -- project folder for Delphi 10.4 Sydney
cd 104Sydney
...
REM -- clean temporary files from previous builds --
del *.res
del /s *.dcu
del /s *.rsm
del /s *.exe
...
dccosx64.exe -$O- --no-config -B -DDEBUG   -E.\OSX64\Debug   -LN"%BDSCOMMONDIR%\Dcp\OSX64" -R"%BDS%\lib\OSX64\release";"%BDS%\redist\OSX64" -U"%BDS%\lib\OSX64\debug";"%BDS%\redist\OSX64"   -NO.\OSX64\Debug   -NU.\OSX64\Debug   -NSSystem -O"%BDS%\lib\OSX64\debug";"%USERPROFILE%\Documents\Embarcadero\Studio\21.0\Imports";"%BDS%\Imports";"%BDSCOMMONDIR%\Dcp\OSX64";"%BDS%\include";"%BDS%\redist\OSX64";"%BDSCOMMONDIR%\Bpl\OSX64"  --syslibroot:"%USERPROFILE%\Documents\Embarcadero\Studio\SDKs\MacOSX10.14.sdk" --frameworkpath:"%USERPROFILE%\Documents\Embarcadero\Studio\SDKs\MacOSX10.14.sdk\System\Library\Frameworks";"%USERPROFILE%\Documents\Embarcadero\Studio\SDKs\MacOSX10.14.sdk\System\Library\PrivateFrameworks" DelphiVersionsFM.dpr
dccosx64.exe -$O+ --no-config -B -DRELEASE -E.\OSX64\Release -LN"%BDSCOMMONDIR%\Dcp\OSX64" -R"%BDS%\lib\OSX64\release";"%BDS%\redist\OSX64" -U"%BDS%\lib\OSX64\release";"%BDS%\redist\OSX64" -NO.\OSX64\Release -NU.\OSX64\Release -NSSystem -O"%BDS%\lib\OSX64\release";"%USERPROFILE%\Documents\Embarcadero\Studio\21.0\Imports";"%BDS%\Imports";"%BDSCOMMONDIR%\Dcp\OSX64";"%BDS%\include";"%BDS%\redist\OSX64";"%BDSCOMMONDIR%\Bpl\OSX64"  --syslibroot:"%USERPROFILE%\Documents\Embarcadero\Studio\SDKs\MacOSX10.14.sdk" --frameworkpath:"%USERPROFILE%\Documents\Embarcadero\Studio\SDKs\MacOSX10.14.sdk\System\Library\Frameworks";"%USERPROFILE%\Documents\Embarcadero\Studio\SDKs\MacOSX10.14.sdk\System\Library\PrivateFrameworks" DelphiVersionsFM.dpr
